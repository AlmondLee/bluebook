...
var params = {
    ...
    id_inf: 3           //ti_xian_backend接口返回的Money_will_give的某一项(行)的id
}



function ti_xian_ok (params) {
}
...
//管理页面(查)
https://www.almondlee.cn/api/ti_xian_backend?super_token=



https://www.almondlee.cn/api/ti_xian?token=dfghkbxjbjkgzsdnjkhsdFUIJKhf


https://www.almondlee.cn/api/get_jssdk
//如果报错请换成生产环境的域名
